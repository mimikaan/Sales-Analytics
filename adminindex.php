                    ...
                    foreach ($cursor as $document) { ?>
                      <tr>
                        ...
                        <td><a class='editlink' data-id=<?php echo $document->_id; ?> href='javascript:void(0)'>Edit</a> |
                          <a onClick ='return confirm("Do you want to remove this record?");' href='record_delete.php?id=<?php echo $document->_id; ?>'>Delete</a>
                          |<a href='bargraph3.php?id=<?php echo $document->product_name;?>'>Analyse</a></td>
                      </tr>
                   <?php $i++;  
                    } 
                  ?>
